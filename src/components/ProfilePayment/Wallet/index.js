    ...
    return (
      <div className={style.myCards}>
        ...
        <p style={{ fontSize: 12, color: "#bbb" }}>
          -Payments will automatically deduct from your wallet before attempting
          to use credit cards or cash.
        </p>
        <div
          style={{
            display: "flex",
        ...
        >
          <BrandedButton
            content="Add Funds"
            styles={{ width: 100, height: 25, fontSize: 12, marginBottom: 30 }}
          />
        </div>
      </div>
    )
